        ...
        <form action="#" class="contact-us-form" novalidate>
            ...
            <div class="contact-us-form-controls-group" data-validation="control-group">
                ...
                <div class="contact-us-form-controls" data-validation="control">
                    <input  data-action="text" type="text" name="firstname" id="firstname" class="contact-us-form-input" value="" maxlength="300"></input>
                </div>
            </div>

            <div class="contact-us-form-controls-group" data-validation="control-group">
                <label class="contact-us-form-label" for="last_name">
                    {{translate 'Last Name <small class="contact-us-form-required">*</small>'}}
                </label>
                <div class="contact-us-form-controls" data-validation="control">
                    <input  data-action="text" type="text" name="lastname" id="lastname" class="contact-us-form-input" value="" maxlength="300"></input>
                </div>
            </div>
