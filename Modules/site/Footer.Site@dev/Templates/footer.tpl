...
<div class="footer-content">
    ...
    <div class="footer-content-nav-copyright">
		<div class="footer-content-text">
			<div class="footer-content-text-title">
				{{footerTitle}}
			</div>
			<div class="footer-content-text-body">
				<div class="footer-content-text-body-primary">
					{{footerPrimaryText}}
				</div>
				<div class="footer-content-text-body-secondary">
					{{footerSecondaryText}}
				</div>
			</div>
		</div>
    ...
    <div class="footer-content-newsletter-social">
        ...
        <div class="footer-content-social">
            ...
            {{#each socialMediaLinks}}
                <li><a {{objectToAtrributes item}} target="_blank">{{#if icon}}<i class="footer-content-social-icon icon-{{icon}}"></i>{{else}}{{text}}{{/if}}</a></li>
            {{/each}}
            </ul>
        </div>
        {{/if}}
