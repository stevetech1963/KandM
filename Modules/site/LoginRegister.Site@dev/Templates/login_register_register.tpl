...
{{/unless}}
    ...
    <div class="login-register-register-form-controls-group">
        <label class="login-register-register-form-label">
            <input type="checkbox" name="nontaxable" id="nontaxable" />
            {{translate 'I am a Tax Exempt Customer'}}
        </label>
    </div>

    <div class="login-register-register-form-controls-group" data-validation="control-group" style="display:none;" id="form-resaleDealerNumber">
        <label class="login-register-register-form-label" for="resaleDealerNumber">
            {{translate 'Resale Dealer Number'}} <small class="login-register-register-form-required">*</small>
        </label>
        <div class="login-register-register-form-controls" data-validation="control">
            <input type="text" name="resaleDealerNumber" id="resaleDealerNumber" class="login-register-register-form-input" />
        </div>
    </div>
