					...
					,	save: function()
						{
                            ...
                            this.wizard.model.attributes.options.custbody_mounting_selected = this.$("#custbody_mounting_selected").val();
                            this.wizard.model.attributes.options.custbody_mounting_notes = this.$('#custbody_mounting_notes_field').val();
