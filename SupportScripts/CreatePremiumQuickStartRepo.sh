...
DENALI_SVN="https://ps-svn01.corp.netledger.com/svn/SVN-PS/Efficiencies/Tags/CommerceApplications/MontBlanc"
QUICKSTART_SVN="https://ps-svn01.corp.netledger.com/svn/SVN-PS/Efficiencies/Tags/Quickstarts/Premium-1.0.0"
...
svn up
svn commit $CUSTOMER/SuiteCommerce/$SITE -m "Mont Blanc"
svn export $QUICKSTART_SVN $CUSTOMER/SuiteCommerce/$SITE --force
svn add $CUSTOMER/SuiteCommerce/$SITE/* --force
svn up
svn commit $CUSTOMER/SuiteCommerce/$SITE -m "Quickstart Premium"
